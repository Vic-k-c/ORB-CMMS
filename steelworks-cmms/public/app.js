...
function logTableRowHtml(l){
  ...
  return `
    <tr>
      <td class="nowrap">${fmtDateTime(l.loggedAt)}</td>
      <td class="nowrap">${escapeHtml(l.machineName)} <span style="color:var(--grey);">(${escapeHtml(l.machineCode)})</span></td>
      <td class="nowrap"><span class="log-type-badge ${l.logType.toLowerCase()}">${l.logType}</span></td>
      <td class="nowrap"><span class="badge ${statusBadgeClass(l.status)}">${l.status}</span></td>
      <td class="nowrap">${l.downtimeHours}</td>
      <td class="wrap-cell" title="${findingsFull}">${findingsFull}</td>

...
with the organization's own logo and name — same file already used for
document letterheads, no separate upload. **The login page stays generic**
and can't be personalized, since the organization isn't known until after
the Organization Code is submitted.
